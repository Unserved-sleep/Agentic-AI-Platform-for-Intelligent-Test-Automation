...
def test_scen_6b8cc4():
    """
    Reject Claim
    Reject a claim and verify the status transitions to REJECTED and no payout record is created
    """
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_prefix = f"RUN-EXEC_SCEN_6B8CC4_{timestamp}_UI"
