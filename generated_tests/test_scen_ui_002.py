...
def test_scen_ui_002():
    """
    Verify Login Error Message for Invalid Credentials on Swag Labs
    User enters locked_out_user credentials and verifies error message.
    """
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_prefix = f"RUN-EXEC_SCEN_UI_002_{timestamp}_UI"
