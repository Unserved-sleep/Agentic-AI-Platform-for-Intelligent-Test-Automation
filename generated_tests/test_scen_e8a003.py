...
def test_scen_e8a003():
    """
    Approve Claim
    Approve a claim and verify the status transitions to APPROVED and a payout record is created
    """
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_prefix = f"RUN-EXEC_SCEN_E8A003_{timestamp}_UI"
