...
def test_scen_3ff4c8():
    """
    Submit Claim with Valid Amount
    Submit a claim with a valid amount and verify the initial status is set to SUBMITTED
    """
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_prefix = f"RUN-EXEC_SCEN_3FF4C8_{timestamp}_UI"
