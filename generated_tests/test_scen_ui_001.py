...
def test_scen_ui_001():
    """
    Verify User Login and Inventory Item Selection on Swag Labs (SauceDemo)
    User logs into https://www.saucedemo.com/ using standard_user credentials, views products page, and adds Sauce Labs Backpack to shopping cart.
    """
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_prefix = f"RUN-EXEC_SCEN_UI_001_{timestamp}_UI"
