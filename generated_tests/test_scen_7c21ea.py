...
def test_scen_7c21ea():
    """
    Boundary Case - Claim Amount at Lower Bound
    Test submitting a claim with a claim amount at the lower bound
    """
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    run_prefix = f"RUN-EXEC_SCEN_7C21EA_{timestamp}_UI"
